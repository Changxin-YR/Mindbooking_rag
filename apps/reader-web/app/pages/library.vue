...
watch(shelf, (items) => {
  for (const item of (items || [])) {
    if (item.title || item.availability === 'UNAVAILABLE' || item.availability === 'NOT_FOUND') continue
